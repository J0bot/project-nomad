...
const SkyViewFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_skyview_free(ptr >>> 0, 1));
...
export class SkyView {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        SkyViewFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_skyview_free(ptr, 0);
    }
    /**
     ...
     */
    catalog_size() {
        const ret = wasm.skyview_catalog_size(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     * @param {number} dec_deg
     * @returns {Float32Array}
     */
    project_radec(ra_hours, dec_deg) {
        const ret = wasm.skyview_project_radec(this.__wbg_ptr, ra_hours, dec_deg);
     ...
     */
    set_longitude(longitude_deg) {
        wasm.skyview_set_longitude(this.__wbg_ptr, longitude_deg);
    }
    /**
    ...
    set_orientation(yaw, pitch) {
        wasm.skyview_set_orientation(this.__wbg_ptr, yaw, pitch);
    }
    /**
     ...
     */
    visible_star_count() {
        const ret = wasm.skyview_visible_star_count(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    set_magnitude_limit(m) {
        const ret = wasm.skyview_set_magnitude_limit(this.__wbg_ptr, m);
        if (ret[1]) {
    ...
    constructor(canvas_id) {
        ...
        const ret = wasm.skyview_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        SkyViewFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    render() {
        wasm.skyview_render(this.__wbg_ptr);
    }
    /**
    ...
    resize(width, height, dpr) {
        wasm.skyview_resize(this.__wbg_ptr, width, height, dpr);
    }
    /**
     ...
     */
    set_fov(fov_deg) {
        wasm.skyview_set_fov(this.__wbg_ptr, fov_deg);
    }
    /**
     ...
     */
    set_time(jd) {
        wasm.skyview_set_time(this.__wbg_ptr, jd);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('skyview_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
